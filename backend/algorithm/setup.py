...
setup(
      ...
      ext_modules=cythonize(
          [
              ...
              Extension(
                  name="algorithm",
                  include_dirs=["./src", "./include/algorithm"],
                  library_dirs=["./src", "./include/algorithm"],
                  sources=["algorithm.pyx", "algorithm.cpp"],  # "algorithm.pyx" and also "algorithm.cpp" must be listed here !!!!
              )
          ],
          language_level=3
      ),
