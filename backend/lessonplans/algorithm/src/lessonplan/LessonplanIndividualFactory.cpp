...
namespace lessonplans {
    ...
    LessonplanIndividual *LessonplanIndividualFactory::createLessonplanIndividualGreedly(
            SchedulingProblemProperties *schedulingProblemProperties) {
        auto *lessonplanIndividual = new LessonplanIndividual();
        auto *lessonplanIndividualDescriptor = new LessonplanIndividualDescriptor();
    ...
    void LessonplanIndividualFactory::assignClassesWithSubjectsGreedly(
            LessonplanIndividual *lessonplanIndividual,
            LessonplanIndividualDescriptor *lessonplanIndividualDescriptor,
            SchedulingProblemProperties *schedulingProblemProperties
    ) {
        ...
        for (unsigned short classIdx = 0; classIdx < classesCount; classIdx++) {
            ...
            for (unsigned short subjectIdx = 0; subjectIdx < classSubjectsCount; subjectIdx++) {
                ...
                for (unsigned short subjectNumber = 1; subjectNumber <= classSubjectEachCount; subjectNumber++) {
                    bool teacherFound = LessonplanIndividualFactory::tryAssignTeacherGreedly(lessonplanIndividual,
                                                                                      lessonplanIndividualDescriptor,
                                                                                      schedulingProblemProperties,
                                                                                      individualDataIdx,
                                                                                      classId, subjectId,
                    ...
                    if (teacherFound) {
                        ...
                        LessonplanIndividualFactory::tryAssignTeacherGreedly(lessonplanIndividual,
                                                                      lessonplanIndividualDescriptor,
                                                                      schedulingProblemProperties,
                                                                      individualDataIdx,
                                                                      classId, subjectId,
    ...
    bool LessonplanIndividualFactory::tryAssignTeacherGreedly(
            LessonplanIndividual *lessonplanIndividual,
            LessonplanIndividualDescriptor *lessonplanIndividualDescriptor,
            SchedulingProblemProperties *schedulingProblemProperties,
            unsigned short individualDataIdx,
        ...
        for (unsigned short teacherIdx = 0; teacherIdx < teachersCount; teacherIdx++) {
            ...
            for (unsigned short subjectIdx2 = 0; subjectIdx2 < teacherSubjectsCount; subjectIdx2++) {
                ...
                if (subjectId == subjectId2) {
                    ...
                    bool roomFound = LessonplanIndividualFactory::tryAssignRoomGreedly(lessonplanIndividual,
                                                                                lessonplanIndividualDescriptor,
                                                                                schedulingProblemProperties,
                                                                                individualDataIdx, classId,
                                                                                subjectId,
    ...
    bool LessonplanIndividualFactory::tryAssignRoomGreedly(
            LessonplanIndividual *lessonplanIndividual,
            LessonplanIndividualDescriptor *lessonplanIndividualDescriptor,
            SchedulingProblemProperties *schedulingProblemProperties,
            unsigned short individualDataIdx,
            ...
            if (roomSubjectsCount > 0) {
                ...
                for (unsigned short subjectIdx3 = 0; subjectIdx3 < roomSubjectsCount; subjectIdx3++) {
                    ...
                    if (subjectId == subjectId3) {
                        ...
                        bool weekDayAndLessonFound = LessonplanIndividualFactory::tryAssignWeekDayAndLessonGreedly(
                                lessonplanIndividual,
                                lessonplanIndividualDescriptor,
                                schedulingProblemProperties,
                                individualDataIdx, classId,
    ...
    bool LessonplanIndividualFactory::tryAssignWeekDayAndLessonGreedly(
            LessonplanIndividual *lessonplanIndividual,
            LessonplanIndividualDescriptor *lessonplanIndividualDescriptor,
            SchedulingProblemProperties *schedulingProblemProperties,
            unsigned short individualDataIdx,
        ...
        for (unsigned short lessonIdx = 0; lessonIdx < lessonsCount; lessonIdx++) {
            ...
            for (unsigned short weekDayIdx = 0; weekDayIdx < weekDaysCount; weekDayIdx++) {
                ...
                if (
                        randomAssign || (
                        !lessonplanIndividualDescriptor->getAssignedLessonAndDayToClass(currentWeekDayIdx,
                                                                                        currentLessonIdx,
                                                                                        classIdx)
                        && !lessonplanIndividualDescriptor->getAssignedLessonAndDayToTeacher(currentWeekDayIdx,
                                                                                             currentLessonIdx,
                                                                                             teacherIdx)
                        && !lessonplanIndividualDescriptor->getAssignedLessonAndDayToRoom(currentWeekDayIdx,
                                                                                          currentLessonIdx,
                                                                                          roomIdx)
                        )
                        ) {
                    ...
                    lessonplanIndividualDescriptor->increaseAssignedLessonAndDayToClass(currentWeekDayIdx,
                                                                                        currentLessonIdx,
                                                                                        classIdx);
                    lessonplanIndividualDescriptor->increaseAssignedLessonAndDayToTeacher(currentWeekDayIdx,
                                                                                          currentLessonIdx,
                                                                                          teacherIdx);
                    lessonplanIndividualDescriptor->increaseAssignedLessonAndDayToRoom(currentWeekDayIdx,
                                                                                       currentLessonIdx,
                                                                                       roomIdx);
